 ...
 */ (function(c) {
    ...
    b.prototype = {
        ...
        constructor: function() {
            ...
            g = this.htmlInput() + '<div class="input-group-btn"><button type="button" class="btn btn-default" id="file-chooser">Choose</button></div>';
            ...
            var self = this;
            $('#file-chooser').on('click', function (e) {
                self.$element.focus().click();
            })
